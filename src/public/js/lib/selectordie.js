        ...
        var _private = {
            ...
            initSoD: function (options) {
                ...
                return this.each(function () {
                    ...
                    if ( !$(this).parent().hasClass("sod-select") ) {
                        var $select                    = $(this),
                        ...
                        $sod = $("<span/>", {
                            id:                        $settingsId,
                            "class":                   "sod-select " + $settingsClass + $selectDisabled,
                            title:                     $selectTitle,
            ...
            focusSod: function () {
                ...
                if ( !$sod.hasClass("disabled") ) {
                    _private.blurSod($(".sod-select.focus").not($sod));
                    $sod.addClass("focus");
            ...
            optionClick: function (e) {
                ...
                var $clicked        = $(this),
                    $sod            = $clicked.closest(".sod-select"),
        ...
        var methods = {
            ...
            update: function () {
                return this.each(function () {
                    var $select  = $(this),
                        $sod     = $select.parent(),
                        $sodList = $sod.find(".sod-list:first");
                ...
                return this.each(function () {
                    ...
                    if ( $sod.hasClass("sod-select") ) {
                        if ( typeof $value !== "undefined" ) { // Disable option/optgroup
                            ...
                            $sod.find(".sod-list:first .sod_option[data-value='" + $value + "']").addClass("disabled");
                            $sod.find(".sod-list:first .sod_option[data-label='" + $value + "']").nextUntil(":not(.groupchild)").addClass("disabled");

                            // Disables the option/optgroup in the real <select>
                            $("option[value='" + $value + "'], optgroup[label='" + $value + "']", this).prop("disabled", true);

                        } else if ( $sod.hasClass("sod-select") ) { // Disable select/SoD
                            $sod.addClass("disabled");
                ...
                return this.each(function () {
                    ...
                    if ( $sod.hasClass("sod-select") ) {
                        if ( typeof $value !== "undefined" ) { // Enable option/optgroup
                            ...
                            $sod.find(".sod-list:first .sod_option[data-value='" + $value + "']").removeClass("disabled");
                            $sod.find(".sod-list:first .sod_option[data-label='" + $value + "']").nextUntil(":not(.groupchild)").removeClass("disabled");

                            // Enables the option in the real <select>
                            $("option[value='" + $value + "'], optgroup[label='" + $value + "']", this).prop("disabled", false);

                        } else if ( $sod.hasClass("sod-select") ) { // Enable select/SoD
